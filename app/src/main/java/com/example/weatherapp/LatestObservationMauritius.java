...
public class LatestObservationMauritius extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_observation_mauritius);
        ...
        new LatestObservationMauritius.BackgroundProccessing().execute();
    }
    ...
    public class BackgroundProccessing extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LatestObservationMauritius.this);
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(LatestObservationMauritius.this,  android.R.layout.simple_list_item_1, titles);
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(LatestObservationMauritius.this,  android.R.layout.simple_list_item_1, description);
            ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(LatestObservationMauritius.this,  android.R.layout.simple_list_item_1, pubdate);
