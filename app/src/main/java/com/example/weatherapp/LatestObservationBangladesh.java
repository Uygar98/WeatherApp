...
public class LatestObservationBangladesh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_observation_bangladesh);
        ...
        new LatestObservationBangladesh.BackgroundProccessing().execute();
    }
    ...
    public class BackgroundProccessing extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LatestObservationBangladesh.this);
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                //bangladesh latest observation url
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/observation/rss/934154");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(LatestObservationBangladesh.this,  android.R.layout.simple_list_item_1, titles);
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(LatestObservationBangladesh.this,  android.R.layout.simple_list_item_1, description);
            ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(LatestObservationBangladesh.this,  android.R.layout.simple_list_item_1, pubdate);
