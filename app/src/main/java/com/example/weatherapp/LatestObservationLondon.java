...
public class LatestObservationLondon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_observation_london);
        ...
        new LatestObservationLondon.BackgroundProccessing().execute();
    ...
    public class BackgroundProccessing extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LatestObservationLondon.this);
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                ...
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/observation/rss/2643743");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(LatestObservationLondon.this,  android.R.layout.simple_list_item_1, titles);
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(LatestObservationLondon.this,  android.R.layout.simple_list_item_1, description);
            ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(LatestObservationLondon.this,  android.R.layout.simple_list_item_1, pubdate);
