...
public class LatestObservationOman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_observation_oman);
        ...
        new LatestObservationOman.BackgroundProccessing().execute();
    }
    ...
    public class BackgroundProccessing extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LatestObservationOman.this);
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                //oman latest observation url
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/observation/rss/287286");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(LatestObservationOman.this,  android.R.layout.simple_list_item_1, titles);
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(LatestObservationOman.this,  android.R.layout.simple_list_item_1, description);
            ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(LatestObservationOman.this,  android.R.layout.simple_list_item_1, pubdate);
